...
public class MainPM {
   ...
   public static void main(String[] args) {            
        ...
        FlyweightStatusItem pesoMosca = new FlyweightStatusItem();
        ...
        for(int i=0; i< 200000; i++){             
            ...
            item1.setNome("lapis");                        
            item1.setStatus(pesoMosca.get(StatusItem.Estado.CARRINHO));
            Item item2 = new Item();
            item2.setDescricao("caneta cor azul");
            item2.setNome("caneta");                                    
            item2.setStatus(pesoMosca.get(StatusItem.Estado.CARRINHO));
            Item item3 = new Item();
            item3.setDescricao("caneta cor vermelha");
            item3.setNome("caneta");                        
            item3.setStatus(pesoMosca.get(StatusItem.Estado.CARRINHO));                       
